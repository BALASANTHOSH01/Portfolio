  ...
  return (
    <div className="mt-[5%] relative">
      ...
      <img
        src={BS_Img}
        alt="Img"
        className="rounded-[50%] md:w-[80%] md:mt-[3%]  w-[30%] mx-auto z-30"
      />

      <div className="my-[2%] flex flex-row md:flex-col px-[8%] mx-auto">

        <div className=" flex flex-col md:flex-row md:gap-[4%] md:justify-center text-white font-extrabold text-[60px] md:text-[40px] w-[30%] md:w-full font-Poppins md:mt-[4%]">
