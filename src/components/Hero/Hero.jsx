    ...
    <div className="text-white flex flex-col justify-around p-2 my-[5%]  max-w-screen-xl mx-auto text-left mt-[5%]">
      <div className=" ml-[17%] sm:ml-[3%]">
        ...
        <p className=" text-white w-[70%] sm:w-[90%] text-[28px] sm:text-[20px] mt-8 tracking-widest font-Poppins font-thin text-left">
          I&apos;m a full-stack developer who creates the web application with
          user-preferred customization.
        </p>
        <div className="flex flex-row sm:flex-col  gap-[12%] mt-[5%] sm:mt-[7%] sm:ml-[10%]">
          <div>
            <h3 className=" tracking-widest font-salsa text-[20px] sm:text-[20px]">
              currently
            </h3>
          ...
          <div>
            <h3 className=" tracking-widest font-salsa text-[20px] sm:text-[20px] sm:mt-[5%]">
              driven by
            </h3>
