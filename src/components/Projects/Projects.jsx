  ...
  return (
    <div >
        <div className="w-[80%] md:mt-[20%] mx-auto text-white">
            <h1 className=" text-[40px] md:text-[30px] py-[5%] text-white font-bold uppercase text-center">Empowering Projects</h1>
            ...
            <div className="flex flex-row md:flex-col gap-7 py-[5%] md:py-[7%] md:border md:border-gray-400 md:my-[10%] md:rounded-[5px]  items-center" >
                <img src={GreenHarbor} alt="project_img" className="w-[40%] md:w-[90%] h-[65vh] md:h-[45vh] rounded-[10px] md:rounded-[5px]"/>
            ...
            <div className="flex flex-row md:flex-col gap-7 py-[5%] md:py-[7%] md:border md:border-gray-400 md:my-[10%] md:rounded-[5px]  items-center" >
                ...
                <img src={Opensource} alt="project_img" className="w-[40%] md:w-[90%] h-[65vh] md:h-[45vh] rounded-[10px] md:rounded-[5px]"/>
            </div>

            <div className="flex flex-row md:flex-col gap-7 py-[5%] md:py-[7%] md:border md:border-gray-400 md:my-[10%] md:rounded-[5px]  items-center" >
                <img src={Noter} alt="project_img" className="w-[40%] md:w-[90%] h-[65vh] md:h-[45vh] rounded-[10px] md:rounded-[5px]"/>
            ...
            <div className="flex flex-row md:flex-col gap-7 py-[5%] md:py-[7%] md:border md:border-gray-400 md:my-[10%] md:rounded-[5px]  items-center" >
                ...
                <img src={Infest2k24} alt="project_img" className="w-[40%] md:w-[90%] h-[65vh] md:h-[45vh] rounded-[10px] md:rounded-[5px]"/>
            </div>

            <div className="flex flex-row md:flex-col gap-7 py-[5%] md:py-[7%] md:border md:border-gray-400 md:my-[10%] md:rounded-[5px]  items-center" >
                <img src={Foodspot} alt="project_img" className="w-[40%] md:w-[90%] h-[65vh] md:h-[45vh] rounded-[10px] md:rounded-[5px]"/>
